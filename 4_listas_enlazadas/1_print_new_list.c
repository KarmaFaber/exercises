/*1. Crear e Imprimir una Lista Enlazada

Descripción: Escribe un programa que cree una lista enlazada simple con tres nodos. 
Asigna valores enteros a cada nodo y luego imprime los valores almacenados en la lista.

Puntos clave: Crear nodos, enlazarlos, y recorrer la lista.*/
